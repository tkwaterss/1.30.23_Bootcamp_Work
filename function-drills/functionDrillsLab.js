...
let nameGreeting = nameCheck("Tobin");
...
/*
  ...
  Create a variable called 'colorRating' and set it equal to faveColorFinder invoked (called), passing in 
  an argument.
*/
...
/*
  ...
  The function should loop over the array of contestant names. If the loser string 
  appears in the array, splice it out. Return the new contestants array.
*/
...
console.log(emailCheck('    bigflippingfloppers@flipityflop.com    '));
...
//CODE HERE
const allTheFrogs = (gold) => {
  return gold/3;
}
let totalFrogs = allTheFrogs(8);
...
//CODE HERE
const allTheFrogs2 = (gold) => {
  return Math.floor(gold/3);
}
let totalFrogs2 = allTheFrogs2(8);
console.log(totalFrogs2);

////////////////// PROBLEM 21 ////////////////////
let sampleArray = [0,1,2,3,7,5,6,8,9]
/*
